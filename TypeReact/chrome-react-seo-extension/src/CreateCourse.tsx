...
export default function CreateCourse() {
    ...
    function update_details() {
        ...
        $.ajax(
            {
                type: 'POST',
                url: 'http://127.0.0.1:8000/add_course/',
                data: { course_name: user_details[0],
                        creator_name: user_details[1],
    ...
    return (
        <Stack spacing={2} direction="column">
            ...
            <TextField id = "creator_name" label = 'creator_name' defaultValue="creator_name" value = {user_details[1]} onChange = {update_pwd}/>
